...
#ifdef _CL3000_PRINTER_MECH
#define GAP_SENSOR_MECHANICAL_OFFSET	369    //369(step) * 0.125(mm/step) = 46.125mm  // 角力 流急芭府 :45.4mm (CL3000)
#else
#define GAP_SENSOR_MECHANICAL_OFFSET	492    //492(step) * 0.125(mm/step) = 61.5mm  // 角力 流急芭府 :60.97mm (CL5200J)
#endif
