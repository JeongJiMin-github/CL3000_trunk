...
#define	FIELD_ID_ARABIC_QTY		24				// Arabic QUANTITY for ARAB (USE_ARABIC_NUMBER)
#else
...
#define	FIELD_ID_NEW_QUANTITY	133
...
#define FIELD_ID_PLU_TRANSACTION_NO	226
...
typedef struct {
	...
	INT32U manufacture_date;		//저울나라 제조일자(yymmdd)
	INT8U  discount_rate;	//저울나라 할인율 
#endif
