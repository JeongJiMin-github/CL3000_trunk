...
#define MAX_FORM_LEN 	960		//3200(step) * 0.125(mm/step) = 400mm
#else
#ifdef USE_LABEL_LENGTH_120MM
#define MAX_FORM_LEN 	960//1600		//960(step) * 0.125(mm/step) = 120mm
#else
#define MAX_FORM_LEN 	640//1600		//640(step) * 0.125(mm/step) = 80mm
#endif
#endif
