...
extern void ingredient_create(void);		// command code 0x1241
extern void ingredient_delete(void);		// command code 0x1242
extern void ingredient_list(void);			// command code 0x1243
