 /* 
 * File:   BLR_EVROOPT_q_D.h
 * Author: JiMin JEONG
 * @brief  globals.h에서 분리된 direct_ingredient를 사용하는 벨라루스 마트 전용 파일
 */

#ifndef BLR_EVROOPT_q_D_H
#define	BLR_EVROOPT_q_D_H

//----------   국가 Default  ----------//
 #define COUNTRY_STR "  "
 #define DEALER_VER_STRING	"(q)"           // 러시아 펌웨어 동일 USE_REALTIME_DATA_EVROOPT기능만 추가.
...
//----------   국가 전용 기능  ----------//
 ...
 #define USE_REALTIME_DATA_EVROOPT          // 벨라루스 EVROOPT 체인 셀프저울 연결 기능
//----------   국가 전용 라벨 설정  ----------//
