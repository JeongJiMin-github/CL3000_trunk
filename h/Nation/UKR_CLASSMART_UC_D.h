 /* 
 * File:   UKR_CLASSMART_UC_D.h
 * Author: JiMin JEONG
 * @brief  globals.h에서 분리된 direct_ingredient를 사용하는 우크라이나 클래스마트 전용 파일
 */

#ifndef UKR_CLASSMART_UC_D_H
#define	UKR_CLASSMART_UC_D_H

//----------   국가 Default  ----------//
 #define COUNTRY_STR "  "
 #define DEALER_VER_STRING	".UC"
