 ...
 * File:   UN_function.h
 * Author: JiMin JEONG
 * @brief  globals.h에서 분리된 영공 공통 기능 전용 파일
 */
...
//----------  유럽 및 영공 전용 기능  ----------//
    ...
    //----------   미국, 캐나다, 호주의 경우 전용 라벨 포맷 사용  ----------//
      #if defined(COUNTRY_AUSTRALIA) || defined(COUNTRY_USA)|| defined(COUNTRY_CANADA)
  ...
  #endif /* USE_EUROPE_CL5200N */
  #ifndef	COUNTRY_STR
        #define COUNTRY_STR "  "
    #endif	/* #ifndef COUNTRY_STR */
#endif  /* UN_function_H */