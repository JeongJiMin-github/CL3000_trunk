...
void prt_get_plu_coolinfo(INT32U plu_addr, STRUCT_COOL_IMAGE *coolinfo)// Plu에 종속된 항
{
	...
	if(coolinfo->CoolOrigin != 0)
	{
		...
		Flash_sread(addr, ( INT8U *)&origin_str, str_size);
	...
	{
		ingredient_text_read(ingredNo, (INT8U*)coolinfo->CoolCustom, 0, DEFAULT_INGREDIENT_TEXT_ALL_SIZE);
	}
...
#endif
	INT8U ret,emart;
#if defined USE_TRACEABILITY || defined USE_LOT_NUMBER_FUNCTION
	INT32U addr;
#endif
	INT32U power;
...
#endif
#if defined(USE_LOTTEMART_ITEMCODE13)
				goto NEXT;
#endif
...
#ifdef USE_SCALE_POS_PROTOCOL	// 저울나라 프로토콜
...
#else
					if (bar_type == CODE128C || bar_type == CODE128X)
#endif
					{
...
/////////////////// Traceability ////////////////////
	...
	//					PrtItemStr.produceddate--;	// Added by CJK 20060123
						...
						date_getbeforeday((short*)&v16_3,(short*)&v16_4,(short*)&v16_5,(short)(PrtItemStr.produceddate-1));
					...
					if(PrtItemStr.produceddate) {
						...
						v16_4 = (INT16U)PrtComStr.time.month;
						v16_5 = (INT16U)PrtComStr.time.date;
						date_getbeforeday((short*)&v16_3,(short*)&v16_4,(short*)&v16_5,(short)PrtItemStr.produceddate);
...
//	int i;
	...
	INT32U addr;
	INT8U tmpQrTrace[CHN_EMART_TRACE_QR_SIZE + 1] = {0, };
	INT16U	key;
		...
		{	
			...
			if(TotalQRFlag == 1)
			{
				...
				if (bar_type == QRCODE)
				{
					...
					LabCmd_DrawBarInField(field_num, bar_type, (char *)QRtemp);
				}
				else
				{
...
//				set_nvram_bparam(NVRAM_QR_ADD_COUNT, 0);
		...
		else // RECEIPT MODE
		{
			...
			if(TotalQRFlag == 1)
			{
				...
				{
					RcptCmd_PrintBarcode(bar_type, bar_str); // 아이템별 바코드 여기에 인쇄
				}
...
//	for (fieldid=0; fieldid<FIELD_ID_N_SERVING_SIZE; fieldid++) {
		...
		if (StrFieldStruct[fieldid].ExistField && select) {
			switch (fieldid) {
...
#ifdef USE_SCALE_POS_PROTOCOL		//저울나라 제조일자 출력으로 사용
					if (PrtItemStr.manufacture_date == 1) continue;

					//if(PrtItemStr.packedondate > 999) continue;		//?

  					//저울나라 제조일자 yymmdd
					v16_3 = (INT16U)(PrtItemStr.manufacture_date / 10000L % 100L);
					v16_4 = (INT16U)(PrtItemStr.manufacture_date / 100L % 100L);
					v16_5 = (INT16U)(PrtItemStr.manufacture_date % 100L);
				...
				case FIELD_ID_NET_WEIGHT:	// by-count의 무게 표시용 or by-weight의 Net weight표시용
					...
					v8_2=dec_ch;
#ifdef USE_FIXEDWEIGHT_UNIT_OZ
					if (PrtWeightUnit == WEIGHT_UNIT_LB)  // lb로 세팅된 저울 
					{
						if (PrtItemStr.l_PluType != PLU_BY_WEIGHT || PrtItemStr.fixed_price){
							if(!ADM_GetData.Zero) //Actual Weight Not Zero
							{
								if(GlbOper.use_oz_fixedweight) // para_754 Use oz in Fixed Weight Unit	1: Fixed Weight 의 단위를 oz로 사용 / 0: Fixed Weight 의 단위를 저울의 현 설정값을 따라가도록 설정
									v32_1 = LbtoOz(PrtItemStr.l_Price.NetWeight, rate, v8_1);  // lb -> oz
								else
									v32_1 = PrtItemStr.l_Price.NetWeight; // lb
							}
							if(GlbOper.use_oz_fixedweight) // para_754 Use oz in Fixed Weight Unit	1: Fixed Weight 의 단위를 oz로 사용 / 0: Fixed Weight 의 단위를 저울의 현 설정값을 따라가도록 설정
							{
								PrtGenWeightStr(string_buf1, v32_1, 8, w_sign1, w_sign2, v8_1, v8_2);	// " (6 lb 4 oz) 2835 g"
								PrtGenWeightStr(string_buf, v32_1, 9, w_sign1, w_sign2, v8_1, v8_2);	// "100 oz"
							}
							else
							{
								PrtGenWeightStr(string_buf1, v32_1, 10, w_sign1, w_sign2, v8_1, v8_2);	// " (100 oz) 2835 g"
								PrtGenWeightStr(string_buf, v32_1, 5, w_sign1, w_sign2, v8_1, v8_2);	// "6.25 lb"
							}
							strcat(string_buf, string_buf1);											// "100 oz (6 lb 4 oz) 2835g" or "6.25 lb (100 oz) 2835 g"
						}
					} 
					else if(PrtWeightUnit == WEIGHT_UNIT_KG)  // kg으로 세팅된 저울
					{
						if (PrtItemStr.l_PluType != PLU_BY_WEIGHT || PrtItemStr.fixed_price){
							if(!ADM_GetData.Zero) //Actual Weight Not Zero
							{
								if(GlbOper.use_oz_fixedweight) // para_754 Use oz in Fixed Weight Unit	1: Fixed Weight 의 단위를 oz로 사용 / 0: Fixed Weight 의 단위를 저울의 현 설정값을 따라가도록 설정
								{
									v32_1 = ad_cnv_weight_unit(PrtItemStr.l_Price.NetWeight,WEIGHT_UNIT_KG,WEIGHT_UNIT_LB); //  kg -> lb
									if (ADM_Status.Dual == 1 && ad_get_max_capa(ADM_Status.Capa, CurPluWeightUnit, 0) == 30000)  // 30kg으로 세팅 저울에서 아랫구간에서 kg <-> lb 간 소수점 차이 남 
									{
										if(PrtItemStr.l_Price.NetWeight < 15000)
											v8_1 = v8_1 - 1;
									}
									v32_1 = LbtoOz(v32_1, 16, v8_1);  // lb -> oz
								}
								else
									v32_1 = PrtItemStr.l_Price.NetWeight;  // kg
							}
							if(GlbOper.use_oz_fixedweight) // para_754 Use oz in Fixed Weight Unit	1: Fixed Weight 의 단위를 oz로 사용 / 0: Fixed Weight 의 단위를 저울의 현 설정값을 따라가도록 설정
							{
								get_global_sparam(GLOBAL_WEIGHT_LBSYMBOL_1, (INT8U *)w_sign1, 4);
							...
							{
								PrtGenWeightStr(string_buf1, v32_1, 11, w_sign1, w_sign2, v8_1, v8_2);	// " 100 oz (6 lb 4 oz)"
								PrtGenWeightStr(string_buf, v32_1, 5, w_sign1, w_sign2, v8_1, v8_2);	// "2.835 kg"
							}
							strcat(string_buf, string_buf1);											// "100 oz (6 lb 4 oz) 2835g" or "2835 g (100 oz) 6.25 lb"
						}
					}
					...
					switch(PrtItemStr.l_PluNo) {
						...
						default :
							...
							else
							{
								...
								{
									if((CurTraceStatus.indivStr.individualNO[0] == '0') || (CurTraceStatus.indivStr.individualNO[0] == '1') || (CurTraceStatus.indivStr.individualNO[0] == '8')) //소, 돼지 ,수입육 
									{
										//개체식별번호
					...
					switch(PrtItemStr.l_PluNo) {
						...
						default :
							...
							else
							{
								...
								#endif
									Flash_sread(addr, (HUGEDATA INT8U *)&string_buf[v8_1], tempSize);
    ...
    #ifdef USE_MARBLING_GRADE_PRINT  //근내지방도 등급 리스트 인쇄 기능
								if(v8_1) //돼지 등급
								{
					...
					switch(PrtItemStr.l_PluNo) {
						...
						default :
							if (CurTraceStatus.gradeNo)
							{
								...
								v16_2 = strlen((char*)TraceMeatGradeListText[v16_1]) - TraceMeatGradeList_Position[v16_1][v8_3 - 1] - TraceMeatGradeList_Len[v16_1][v8_3 - 1] - 2;
				...
				case FIELD_ID_SELL_BY_TIME:	// Sell by Time = Packed Time + hour
					...
					if (PrtItemStr.sellbydate < 2 && PrtItemStr.sellbytime) 		// Sell by Date 이 0 이나 1이고 Sell by Time존재시만 프린트 함
					#else
					if (PrtItemStr.sellbydate || PrtItemStr.sellbytime) 		// Sell by Date or Sell by Time존재시					
					#endif
					#else
				...
				case FIELD_ID_INGREDIENT_STR: 	// ingredient PAGE1
					...
					if (v16_1) 
					{
						if(v8_2) //direct ingredient
						{
							...
							for(i = 0; string_buf2[i] != 0 && i < DEFAULT_INGREDIENT_TEXT_ALL_SIZE; i++) {
								if(string_buf2[i] == 0x0c) {
							...
							start = (len[fieldid - FIELD_ID_INGREDIENT_STR]) ? len[fieldid - FIELD_ID_INGREDIENT_STR] + 1 : 0;
							end = len[fieldid - FIELD_ID_INGREDIENT_STR + 1] - start;
							if(end > 0)
...
//					if(label_set.en_mark_down_weight == 0) continue;
				...
				case FIELD_ID_LOT_NUMBER :
					...
					break;
#endif
				case FIELD_ID_PLU_TRANSACTION_NO :
					sprintf(string_buf, "%ld", PrtItemStr.plu_tran_no+1);
					break;
				default :
					continue;
			}
		...
		if (StrFieldStruct[fieldid].ExistField && select) {
			switch (fieldid) {
				case FIELD_ID_TRACEABILITY_CODE:	// Pass Next field
					...
					continue;
				case FIELD_ID_TRANSACTION_NO :		// Pass Label Serial Number
					continue;
...
// END // SCALE_POS_PROTOCOL
...
#ifdef USE_ARABIC_NUMBER
				case FIELD_ID_ARABIC_QTY: // Arabic Quantity
#endif //USE_ARABIC_NUMBER	
				...
				case FIELD_ID_TOTAL_PRICE_IN_TAX : // Total Price with Tax (Include Tax)
					...
					// * Internal Tax : Total Price에 세금 가격 포함
					// * External Tax : Total Price에 세금 가격 미포함
					...
					// ex 1) Internal Tax Type 10%, Total Price 1.00
					//        -> Tax Price = 0.09
					//        -> Total Price(Include tax) = 1.00
					// ex 2) External Tax Type 10%, Total Price 1.00
					//        -> Tax Price = 0.10
					//        -> Total Price(Include tax) = 1.10
			...
			if(DirectSetField) {
				LabCmd_SetTextField_Direct(fieldid,(char *)addr,v16_2);
			} else {
	 			LabCmd_SetTextField(fieldid,string_buf);
			}
		}
...
#ifndef	USE_SCALE_POS
					v16_1 = get_net_wparam(NETWORK_SCALE_ID);
					sprintf(string_buf,"%d", v16_1);
#else	
					//USE_SCALE_POS	//저울나라 할인율 출력
					if(PrtItemStr.discount_rate== 0) continue;
					v16_1 = PrtItemStr.discount_rate;
					sprintf(string_buf, "%02d%%", v16_1);
#endif	//USE_SCALE_POS
					break;
				default :
					continue;
				...
				case FIELD_ID_NET_WEIGHT:
					...
					if (PrtWeightUnit == WEIGHT_UNIT_LB)
					{
						if (PrtItemStr.l_PluType != PLU_BY_WEIGHT || PrtItemStr.fixed_price){
							...
							{
								v32_1 = PrtTotalStr.TotalNetWeight;
								PrtGenWeightStr(string_buf, v32_1, 10, w_sign1, w_sign2, v8_1, v8_2);	// "100 oz"
								sprintf(string_buf1, " (%s)", string_buf);								// " (6 lb 4 oz)"
								PrtGenWeightStr(string_buf, v32_1, 5, w_sign1, w_sign2, v8_1, v8_2);	// "100 oz"
							}
							strcat(string_buf, string_buf1);	 										// "100 oz( 6 lb 4 oz)"
						}
					}
					else if (PrtWeightUnit == WEIGHT_UNIT_KG)
					{									
						if (PrtItemStr.l_PluType != PLU_BY_WEIGHT || PrtItemStr.fixed_price){
							if(GlbOper.use_oz_fixedweight) // para_754 Use oz in Fixed Weight Unit	1: Fixed Weight 의 단위를 oz로 사용 / 0: Fixed Weight 의 단위를 저울의 현 설정값을 따라가도록 설정
							{
								...
								get_global_sparam(GLOBAL_WEIGHT_LBSYMBOL_1, (INT8U *)w_sign1, 4);
								get_global_sparam(GLOBAL_WEIGHT_LBSYMBOL_2, (INT8U *)w_sign2, 4);
								PrtGenWeightStr(string_buf, v32_1, 9, w_sign1, w_sign2, v8_1, v8_2);	// "100 g"
								PrtGenWeightStr(string_buf1, v32_1, 8, w_sign1, w_sign2, v8_1, v8_2);	// " 2835 oz (6 lb 4 oz)"
							}
							else
							{
								v32_1 = PrtItemStr.l_Price.NetWeight;  // kg
								PrtGenWeightStr(string_buf1, v32_1, 11, w_sign1, w_sign2, v8_1, v8_2);	// " 100 oz (6 lb 4 oz)"
								PrtGenWeightStr(string_buf, v32_1, 9, w_sign1, w_sign2, v8_1, v8_2);	// "2835 g"
							}
...
#ifdef USE_SCALE_POS_PROTOCOL
			PrtItemStr.manufacture_date = LabelData.manufacture_date;			//저울나라 제조일자
			PrtItemStr.discount_rate = LabelData.discount_rate;		//저울나라 할인율
#endif
...
INT8U Prt_PrintLabel(INT8U label_mode, INT8U linked)
{
	...
	if(label_mode == ITEM_LABEL || label_mode == TEST_LABEL) {
		...
		if(!PrtFirstLabel) Delay_100ms(15);
#endif		
		...
		case PRT_TOTAL_NORMAL_MODE :
			...
			if (training_prt)
			{
				...
				if ( clerk_st.training == 1)
				{
					...
					RcptCmd_SetFontStyle(3, RPT_FONT_TITLE, TKT_LAY_N, 0, CENTER);
...
////////////////////////////////////////////////////////////////KKH 110427 Ticket mode head message add
	...
	if(strlen((char*)strTemp1))
	{
        ...
        RcptCmd_SetFontStyle(3, RPT_FONT_SUBTITLE, TKT_LAY_N, 0, CENTER);
...
#else
    RcptCmd_SetFontStyle(3, RPT_FONT_TITLE, TKT_LAY_N, 0, RIGHT);
