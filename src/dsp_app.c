...
#elif defined(USE_CANADA_UNIT_PRICE_DOT_DISP)
INT8U signTableIndex[DSP_MAX_SYMBOL] = 
{
	21, // SIGN_STABLE
	19, // SIGN_ZERO
...
void display_clear(INT8U mode)
{
	...
	VFD7_display_string((HUGEDATA char *)data, display_parameter.mode_pos[mode], (char)display_parameter.mode_len[mode], mode, FALSE);
}
