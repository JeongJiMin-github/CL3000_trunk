...
REPT_112:	 
	...
	REPT_117:	 
			...
			case 128: 
				...
				break;
#endif	// #ifdef USE_LOGISTICS_PLU#endif	// #ifdef USE_PROTOCOL_CL5000JR
#endif
			case   0:serial_command[com_type]=0;
				...
				switch(r_data) {
                    ...
                    case 'D' : serial_mode[com_type] = 70; break;
#endif
                    case '^' :
                    case '*' :
                    case '$' :
...
//fdef USE_REALTIME_DATA_EVROOPT                        
                        //case 'S': serial_mode[com_type]=42; break;
//ndif
...
/*fdef USE_REALTIME_DATA_EVROOPT
			case  42: //"IxxSxx<0x0a>"
                  if (r_data==0x0a) { // I00S00<0x0a>
                    commun_getstate(CBuf,serial_command[com_type],serial_number[com_type],0);
                    serial_mode[com_type]=0;
                     goto TX_PROC;
                  }
                  serial_number[com_type]<<=4;
...
#ifndef USE_INDIA_FUNCTION
#ifdef USE_REALTIME_DATA_EVROOPT
INT16U make_realtime_data_trans (char *buffer)
{
    ...
    long  tare;
                        ...
                        format_fixed_zero(&buffer[r], weight, 0, 5, '.');
#ifdef USE_UNDER_LIMIT_MINUS20D
                        if(Operation.UnderWeight == ON)
                        {
                            for (i = 0; i < 5; i++) buffer[r + i] = '-';
                        }
#endif            
                        r += 5;
                        buffer[r++] = '.';
            /////////////////////////////////////TARE/////////////////////////////////////////
                        memcpy(&buffer[r], "T=", 2);
                        r += 2;
                        tare = status_scale.Tare;
                        format_fixed_zero(&buffer[r], tare, 0, 4, '.');
                        r += 4;
                        buffer[r++] = '.';  
            /////////////////////////////////////HEAD UP/////////////////////////////////////////
                        memcpy(&buffer[r], "H=", 2);
                        r += 2;
                        if(PeelHeadMsgFlag == 1) flag = 0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////PEEL OFF/////////////////////////////////////////
                        memcpy(&buffer[r], "P=", 2);
                        r += 2;
                        if(PeelHeadMsgFlag == 2) flag = 0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////PAPER END/////////////////////////////////////////
                        memcpy(&buffer[r], "E=", 2);
                        r += 2;
                        if(PrtDrvStruct.OutOfPaperFlag) flag =0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////ZERO/////////////////////////////////////////
            ...
            /////////////////////////////////////STABLE/////////////////////////////////////////
                        memcpy(&buffer[r], "S=", 2);
                        r += 2;
                        if(ADM_GetData.Stable) flag =0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////OVERLOAD/////////////////////////////////////////
                        memcpy(&buffer[r], "O=", 2);
                        r += 2;
                        if(ADM_GetData.Overload) flag =0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////READY/////////////////////////////////////////
                        memcpy(&buffer[r], "R=", 2);
                        r += 2;
                        if(PrintUseFlag || MenuFlag) flag = 0x31;
                        else flag = 0x30;
                        buffer[r++] = flag;
                        buffer[r++] = '.';  
            /////////////////////////////////////CHECK SUM/////////////////////////////////////////
                       bcc=gen_bcc((INT8U *)&buffer[5],r-5);
                        buffer[r++]=bcc;
...
void realtime_data_trans(void)
{
	...
	if(CheckTimeOver10ms(10, sendWeightTime))     
	{
		sendWeightTime = SysTimer10ms;
        CBuf = &CommBufEthData[0];        
        commun_buffer=(char *)serial_send_point_for_client;

         slen = make_realtime_data_trans(commun_buffer);
...
INT8U commun_send_plu_from_address(HUGEDATA COMM_BUF *CBuf,INT16U address,INT32U xptype,INT8U xmode)
{
	...
	for (i=0; i<plu_n_field; i++) {
		...
		else if (sz == 0)   continue;		// EFG 오류 수정
#endif
...
INT8U  table2_delete_any(INT8U part,INT8U mode,INT16U id)
{
	...
	switch (part) 
	{
		...
		case TABLE2_NUTRITION_FACT: 
			...
			else if (nutri_type == NUTRI_TYPE_2COL_USA)
			{
...
///////////////////
	...
	commun_outleng(CBuf, (char *)buf, cnt);
}
