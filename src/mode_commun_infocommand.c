...
void commun_getstate(HUGEDATA COMM_BUF *CBuf,INT8U action,INT32U cmd,INT32U fnumber)
{
	INT16S    n,ret;
	INT16S    r,start_r;
	char  *commun_buffer;
...
//	switch (cmd) {
        ...
        /////////////////////////////////////WEIGHT/////////////////////////////////////////
                    memcpy(commun_buffer, "I00:LC=000.", 11);
                    r = 11;

                    memcpy(&commun_buffer[r], "W=", 2);
                    r += 2;

                    weight = status_scale.Weight;

                    format_fixed_zero(&commun_buffer[r], weight, 0, 5, '.');
#ifdef USE_UNDER_LIMIT_MINUS20D
                    if(Operation.UnderWeight == ON)
                    {
                        for (i = 0; i < 5; i++) commun_buffer[r + i] = '-';
                    }
#endif            
                    ...
                    commun_buffer[r++] = '.';
        /////////////////////////////////////TARE/////////////////////////////////////////
                    memcpy(&commun_buffer[r], "T=", 2);
                    r += 2;
                    tare = status_scale.Tare;
                    format_fixed_zero(&commun_buffer[r], tare, 0, 5, '.');
                    r += 5;
                    commun_buffer[r++] = '.';  
        /////////////////////////////////////HEAD UP/////////////////////////////////////////
                    memcpy(&commun_buffer[r], "H=", 2);
                    r += 2;
        			if(PeelHeadMsgFlag == 1) flag = 0x31;
        			//Check_Peel_Head_Sensor();
        			//if(PrtDrvStruct.HeadUpFlag) flag = 0x31;
        			//if (HEADUP) flag = 0x31;
        			else flag = 0x30;
                    commun_buffer[r++] = flag;
                    commun_buffer[r++] = '.';  
        /////////////////////////////////////PEEL OFF/////////////////////////////////////////
                    memcpy(&commun_buffer[r], "P=", 2);
                    r += 2;
        ...
        /////////////////////////////////////OVERLOAD/////////////////////////////////////////
                    ...
                    commun_buffer[r++] = '.';  
        /////////////////////////////////////READY/////////////////////////////////////////
                    memcpy(&commun_buffer[r], "R=", 2);
                    r += 2;
                    if((PrintUseFlag == ON)|| (status_run.run_mode == RUN_PROGRAM) || ( MenuFlag== ON)) flag = 0x31;
                    else flag = 0x30;
                    commun_buffer[r++] = flag;
                    commun_buffer[r++] = '.';  
        /////////////////////////////////////CHECK SUM/////////////////////////////////////////
                    bcc=gen_bcc((INT8U *)&commun_buffer[5],r-5);
                    commun_buffer[r++]=bcc;
                    commun_outleng(CBuf,(char *)commun_buffer,r);
}
#endif
...
INT8U commun_direct_nutrition_delete( COMM_BUF *CBuf,INT32U spart,INT8U mode)
{
	...
	if(mode) {
		...
		//delete all
		Flash_clear(DFLASH_BASE + FLASH_NUTRIFACT_AREA, 0, MAX_NUTRIFACT4_NO * str_size);
	}
	return 1;
}
#endif
