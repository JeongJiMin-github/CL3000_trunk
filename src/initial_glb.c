...
#endif
//#ifdef USE_EMART_DEFAULT //delete csh 20140226
...
#elif (defined(USE_GSMART_DEFAULT) || defined(USE_EMART_DEFAULT) || defined(USE_LOTTESUPER_DEFAULT))
...
//	{  310,	     0, 	GLOBAL_SALE_SETUP_FLAG2,     	FLASH_GLOBAL_AREA,		1,    	    4,	     4,	       1,	COUNTRY_KR},  //   Use Double Speed Key
 ...
 #elif defined(USE_GSMART_TRACE_DEFAULT) || defined(USE_LOTTEMART_DEFAULT) || defined(USE_LOTTESUPER_DEFAULT) || defined(USE_NHMART_SAFE_DEFAULT) || defined(USE_HYUNDAI_DEFAULT)
	...
	{  321,	     0,		GLOBAL_SALE_SETUP_FLAG10,	FLASH_GLOBAL_AREA,		1,    	    4,	     2,	       3,	COUNTRY_UN}, //Menu1873 Use saving trace. no :
 #endif
...
//	{  534,	     COUNTRY_US, 	1   },	{  534,	     COUNTRY_US, 	1   },
	...
	{  548, 	 COUNTRY_UN,	4	}, //Nutrifact Print
#else
	{  548, 	 COUNTRY_UN,	0	}, //Nutrifact Print
#endif
	{  548,	     COUNTRY_US,	9   },// 9 : Use US Nutrition fact

	{  550,		 COUNTRY_UN, 	200 }, //Out Of Paper Threshold

	{  551,	     COUNTRY_UN,	0   }, //20080609  Use double print(auto)
#ifdef USE_SRILANKA_CERTI
	{  554,	     COUNTRY_UN,	1   },//Prevent sale of same WT
#endif
...
//	{  555,	     COUNTRY_KR,	1   },//Packed Time(dep.Sellbytime)	// Deleted by CJK 20061120
...
#ifdef USE_AUSTRALIA_DEFAULT
	{  557, 	 COUNTRY_UN,	1	},//Scanner Working Mode
#else
	...
	{  556,	     COUNTRY_UN,	1   },//Use PS2 port for Scanner
#endif
#if (defined(USE_STANDARD_TRACE_DEFAULT) || defined(USE_GSMART_TRACE_DEFAULT) || defined(USE_EMART_DEFAULT) || defined(USE_LOTTEMART_DEFAULT) || defined(USE_LOTTESUPER_DEFAULT))
...
#ifdef USE_EMART_DEFAULT
	{  717,	     COUNTRY_KR,        1   },// Use Checking Indiv.No
	...
	{  737,	     COUNTRY_UN,	1   },//ESD test mode (LCD reset)
#endif
...
#elif defined USE_AUSTRALIA_DEFAULT
	{  739, 	 COUNTRY_UN,	1	},//Weight,Quantity Unit symbol Print setting (0~2)
#else
	{  739,	     COUNTRY_UN,	0   },//Weight,Quantity Unit symbol Print setting (0~2)
#endif
#ifdef USE_CANADA_CERTI_DEFAULT
	{  739,	     COUNTRY_US,	1   },//Weight,Quantity Unit symbol Print setting (0~2)
#endif
	{  740,	     COUNTRY_UN,	0   },//Unit price Unit symbol Print setting (0~5))
#ifdef USE_CANADA_CERTI_DEFAULT
	{  740, 	 COUNTRY_US,	2	},//Weight,Quantity Unit symbol Print setting (0~2)
#endif
	...
	{  773,	     COUNTRY_US,	0   },
#endif
#if defined(COUNTRY_INDONESIA) || defined(USE_VIETNAM) || defined(USE_VIETNAM_EMART) || defined(USE_INDONESIA_EMPORIUM) || defined(USE_MON_EMART)
	{  741,	     COUNTRY_UN,	1 	},//Enable Use 1000 separator Sign
#else
	{  741,	     COUNTRY_UN,	0 	},	
#endif
#if defined(USE_USA_DEFAULT) || defined(USE_CANADA_DEFAULT)
	{  754, 	 COUNTRY_US,	1	}, //Use oz for fixedweight unit
#endif
	...
	{  775,	     COUNTRY_US,	0   },
#ifdef USE_AUSTRALIA_DEFAULT
	{  776, 	 COUNTRY_UN,	1	},//Enable Nutri-fact
#endif
...
#if defined(USE_VIETNAM_EMART_DEFAULT) || defined(USE_PERSIA_DEFAULT) || defined(USE_MON_EMART_DEFAULT) || \
	defined(USE_MONGOL_DEFAULT) || defined(USE_INDONESIA_DEFAULT) || defined(USE_HUNGARY_DEFAULT)
...
//MENU SETTING DEFAULT
...
#endif
#if defined (USE_EMART_DEFAULT) || defined (USE_INDIA_DEFAULT)
	...
	{ 1502,	     COUNTRY_UN,	99  },	//Standard Label ID
#elif defined (USE_INDIA_TATA_DEFAULT)
	{ 1502, 	 COUNTRY_UN,	78	},	//Standard Label ID
#else
...
#endif
#ifdef USE_CANADA_CERTI_DEFAULT
	{ 1502,	     COUNTRY_US,	51  },	//Standard Label ID 인증용 라벨
#elif defined USE_DOMINICA_DEFAULT
...
#endif
#ifdef USE_CANADA_CERTI_DEFAULT
	{ 1503, 	 COUNTRY_US,	51	},	//Misc. Label ID  인증용 라벨
#elif defined USE_DOMINICA_DEFAULT
...
#ifdef USE_INDIA_TATA_DEFAULT
	{ 1504,	     COUNTRY_UN,	53  },	//Add-up TTL Label ID
#else
	...
	{ 1509, 	 COUNTRY_UN,	2  },	//PLU weight barcode No.
#elif defined(USE_INDIA_TATA_DEFAULT)
	{ 1509, 	 COUNTRY_UN,	1  },	//PLU weight barcode No.
#else
	{ 1509, 	 COUNTRY_UN,	0  },	//PLU weight barcode No.
#endif
#ifdef USE_INDIA_DEFAULT
	{ 1510, 	 COUNTRY_UN,	3  },	//PLU count barcode No.
#elif defined(USE_INDIA_TATA_DEFAULT)
	{ 1510, 	 COUNTRY_UN,	2  },	//PLU count barcode No.
#else
	{ 1510, 	 COUNTRY_UN,	0  },	//PLU count barcode No.
#endif
#ifdef USE_INDIA_DEFAULT
	{ 1511, 	 COUNTRY_UN,	3  },	//PLU pcs barcode No.
#elif defined(USE_INDIA_TATA_DEFAULT)
	{ 1511, 	 COUNTRY_UN,	2  },	//PLU pcs barcode No.
#else
	{ 1511, 	 COUNTRY_UN,	0  },	//PLU pcs barcode No.
#endif
#ifdef USE_INDIA_DEFAULT
	{ 1516, 	 COUNTRY_UN,	1  },	//Add up TTL  barcode No.
#elif defined(USE_INDIA_TATA_DEFAULT)
	{ 1516, 	 COUNTRY_UN,	3  },	//Add up TTL  barcode No.
#else	
	{ 1516, 	 COUNTRY_UN,	0  },	//Add up TTL  barcode No.
#endif
#ifdef USE_INDIA_TATA_DEFAULT
	{ 1517, 	 COUNTRY_UN,	3  },	//Add up TTL  barcode2 No.
#else
	...
	{ 1505,	     COUNTRY_UN,	0  },	//Rotate Total Label
#if defined (USE_INDIA_DEFAULT) || defined(USE_INDIA_TATA_DEFAULT)
	{ 1506,	     COUNTRY_UN,	1  },	//Rotate Item Label
#else
	...
	{ 1807,	     COUNTRY_CN,	0  },	//M1840 Time  Format (0=24,1=12)  :
...
#endif
#if defined(USE_INDIA_DEFAULT) || defined(USE_INDIA_TATA_DEFAULT)
	{ 1774,	     COUNTRY_UN,	15  },	//Print Intensity (0-20)
#else
	{ 1774,	     COUNTRY_UN,	10  },	//Print Intensity (0-20) --> when save (*30)//HYP 20040811
#endif
#if defined(USE_USA_DEFAULT) || defined(USE_CANADA_DEFAULT)
	{ 1774,	     COUNTRY_US,	20  },	//Print Intensity (0-20)
#endif
#ifdef USE_CHN_CART_SCALE
...
#if defined(USE_INDIA_DEFAULT) || defined(USE_INDIA_TATA_DEFAULT)
	{ 1777,	     COUNTRY_UN,	7  },	//Preprint Length (0-10)
#else
 ...
 #endif
#endif
	{ 1775,	     COUNTRY_UN,	0  },	//Feed Adjustment (0-400)
...
#if defined(USE_INDIA_DEFAULT) || defined(USE_INDIA_TATA_DEFAULT)
	{ 1837,	     COUNTRY_UN,	1  },	// Enable Quick PLU CJK070130
#else
	...
	{ 1828, 	 COUNTRY_CN,	1  },	//Menu1873 Print count w.o misc. key:
	{ 1829, 	 COUNTRY_UN,	1  },	//Menu1873 Print weight w.o misc. key :
	{ 1829, 	 COUNTRY_CN,	1  },	//Menu1873 Print weight w.o misc. key :
...
#ifdef USE_ARAB
	{ 1071,	     COUNTRY_UN,	0  },	//Total Price Mark Down(MENU 1720)
	{ 1072,	     COUNTRY_UN,	0  },	//Unit Price Mark Down(MENU 1720)
#else
...
//	{ 1841,	     COUNTRY_KR, 	0  },  //   Use Double Speed Key(MENU 1873)
 ...
 #elif defined(USE_GSMART_TRACE_DEFAULT) || defined(USE_LOTTEMART_DEFAULT) || defined(USE_EMART_DEFAULT) || defined(USE_NHMART_SAFE_DEFAULT) || defined(USE_HYUNDAI_DEFAULT)
	...
	{ 1850,	     COUNTRY_UN, 	1  },  //Menu1873 Use Ext.Barcode as ItemCode (IND Only)
...
//DEL CJK070321	{  564,	     0x4564,	 GLOBAL_PRINT_OPER_FLAG2,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     5,	       1,	COUNTRY_EMPTY},  //  10
...
#endif	
	{  566,	     0x4566, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     4,	       1,	COUNTRY_EMPTY},  //   3
	...
	{  570,	     0x4570, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     2,	       1,	COUNTRY_EMPTY},  //  10
	{  571,	     0x4571, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     3,	       1,	COUNTRY_EMPTY},  //   1
...
//	{  580,	     0x4580, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     1,	       1,	COUNTRY_EMPTY},  //   3
	{  581,	     0x4581, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     6,	       1,	COUNTRY_EMPTY},  //   4
	{  582,	     0x4582, 	 GLOBAL_SALE_SETUP_FLAG1,     	FLASH_GLOBAL_AREA, 	1,    	    4,	     7,	       1,	COUNTRY_EMPTY},  //   5
...
//CJK070413	{  710,      0x4710,	 GLOBAL_REPORT_FLAG2  ,		FLASH_GLOBAL_AREA, 	1,    	    4,	     3,	       1,	COUNTRY_EMPTY},  //
...
#endif
#ifdef USE_CL3000_LCD_ESD_TEST
	{  737,	     0x4737, 	 GLOBAL_SALE_SETUP_FLAG15,		FLASH_GLOBAL_AREA,	1,    	    4,	     3,	       2,	COUNTRY_EMPTY},  //   0
#endif
	...
	{  754,	     0x474c, 	 GLOBAL_SALE_SETUP_FLAG18,	FLASH_GLOBAL_AREA,	1,    	    4,	     5,	       1,	COUNTRY_EMPTY},  //   1
#endif	

	{  764, 	 0x4764,	 GLOBAL_SALE_SETUP_FLAG20,		FLASH_GLOBAL_AREA,	1,			8,		 1, 	   1,	COUNTRY_EMPTY},  //   0
...
#if defined(USE_TAX_RATE) || !(defined (USE_ONLY_LABEL) || defined (USE_RUSSIA_DEFAULT))
...
//	{  1841,	  0x3899,	 	GLOBAL_SALE_SETUP_FLAG2,	     	FLASH_GLOBAL_AREA,	  1,      4,      4,      1,	  COUNTRY_EMPTY	 },//제거됨
...
//M1855
	{  1856,      0x1D60,       GLOBAL_SALE_SETUP_FLAG19,            FLASH_GLOBAL_AREA,    1,      4,      2,      1,      COUNTRY_EMPTY  },
#endif
...
//	{  1917,	  0x1a24,		FLASH_REMOTE_IP2+4, 				0,					  2,	  2,	  0,	  1,	  COUNTRY_UN  },//Menu 1914
	...
	{  1923,	  0x3f2d,		GLOBAL_QR_CFG_DEL_LAST_SUFFIX,		FLASH_GLOBAL_AREA, 	  1,	  1,	  0,	  0,	  COUNTRY_UN  },//Menu 1264
				...
				case 980:
					if (changed&0x02)	// changed only
					{
						...
						if(language_flag&0x08)	//Parameter 980 : Y로 설정시 PLU 한글 출력 가능.
						{
							...
							{
								set_global_bparam(GLOBAL_MENU_FONTID 	, DSP_SMALL_FONT_ID);	//8 by 16사용
							}
